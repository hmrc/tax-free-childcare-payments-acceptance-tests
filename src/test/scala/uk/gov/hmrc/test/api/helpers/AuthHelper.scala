...
class AuthHelper {
  ...
  def getAuthBearerToken(nino: String, confidenceLevel: Int, affinityGroup: String): String = {
    val authServiceRequestResponse: StandaloneWSRequest#Response =
      authAPI.postLogin(nino, confidenceLevel, affinityGroup)
