...
trait CommonSpec extends BaseSpec with HttpClient with RestAssured {
  ...
  def tfcLinkInvalidJson(
    ...
    getRequestSpec
      ...
      .header("Correlation-ID", correlationId)
      .when()
      .body(payload.linkPayloadInvalidJson(eppUniqueCusId, eppRegRef, outboundChildPayRef, childDOB))
      .post(url + s"/link")
      .andReturn()
  def tfcLinkInvalidDataTypeCorrelationID(
    token: String,
    correlationId: Int,
    eppUniqueCusId: String,
    eppRegRef: String,
  ...
  def tfcBalanceInvalidJson(
    ...
    getRequestSpec
      ...
      .header("Correlation-ID", correlationId)
      .when()
      .body(payload.balancePayloadInvalidJson(eppUniqueCusId, eppRegRef, outboundChildPayRef))
      .post(url + s"/balance")
      .andReturn()
  def tfcBalanceInvalidDataTypeCorrelationID(
    token: String,
    correlationId: Int,
    eppUniqueCusId: String,
    eppRegRef: String,
  ...
  def tfcPaymentInvalidJson(
    ...
    getRequestSpec
      ...
      .when()
      .body(
        payload.paymentPayloadInvalidJson(
          eppUniqueCusId,
          eppRegRef,
          outboundChildPayRef,
          paymentAmount,
      ...
      .post(url + "/")
      .andReturn()
  def tfcPaymentInvalidDataTypeCorrelationID(
    token: String,
    correlationId: Int,
    eppUniqueCusId: String,
    eppRegRef: String,
    ...
    getRequestSpec
      ...
      .post(url + "/")
      .andReturn()
  def tfcPaymentInvalidFieldPostcode(
    token: String,
    correlationId: String,
    eppUniqueCusId: String,
    eppRegRef: String,
    ...
    getRequestSpec
      ...
      .when()
      .body(
        payload.paymentInvalidFieldPostcodePayload(
          eppUniqueCusId,
          eppRegRef,
          outboundChildPayRef,
          paymentAmount,
  ...
  def tfcPaymentWithoutPayeeType(
    ...
    getRequestSpec
      ...
      .post(url + "/")
      .andReturn()
  def tfcPaymentInvalidFieldPayeeType(
    token: String,
    correlationId: String,
    eppUniqueCusId: String,
    eppRegRef: String,
    ...
    getRequestSpec
      ...
      .when()
      .body(
        payload.paymentPayloadInvalidFieldPayeeType(
          eppUniqueCusId,
          eppRegRef,
          outboundChildPayRef,
          paymentAmount,
      ...
      .post(url + "/")
      .andReturn()
  def tfcPaymentInvalidDataTypePayeeType(
    token: String,
    correlationId: String,
    eppUniqueCusId: String,
    eppRegRef: String,
    ...
    getRequestSpec
      ...
      .when()
      .body(
        payload.paymentPayloadInvalidDataTypePayeeType(
          eppUniqueCusId,
          eppRegRef,
          outboundChildPayRef,
          paymentAmount,
  ...
  def tfcPaymentWithInvalidCCPRegReference(
    ...
    getRequestSpec
      ...
      .post(url + "/")
      .andReturn()
  def tfcPaymentWithInvalidFieldCCPRegReference(
    token: String,
    correlationId: String,
    eppUniqueCusId: String,
    eppRegRef: String,
    ...
    getRequestSpec
      ...
      .when()
      .body(
        payload.paymentPayloadWithInvalidFieldCcpRegReference(
          eppUniqueCusId,
          eppRegRef,
          outboundChildPayRef,
          paymentAmount,
